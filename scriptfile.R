...
tb <- udpipe_read_conllu("test-real-to-modify.conllu")
...
modifications <- readxl::read_xlsx("test-real-modifier.xlsx", sheet = 1)
...
# Load the annotation excel sheet from the directory
modifications_2 <- readxl::read_xlsx("test-real-modifier.xlsx", sheet = 2)
...
# Export the resulting conllu file by UTF-8 Encoding
cat(changed_numbered_tb_conllu, file = file("test-real-done.conllu", encoding = "UTF-8"))
